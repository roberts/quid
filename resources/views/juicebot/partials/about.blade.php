<section class="flex p-8 flex-col md:flex-row-reverse items-center gap-y-6" style="background-image: url('img/QUIDWEB/Burbujas.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
    <img 
        alt="juice-character" 
        loading="lazy" 
        width="1280" 
    ...
    <div class="flex flex-col items-center md:items-start gap-y-6 md:pr-[6rem] md:pl-[6rem] md:w-1/2">
        <h3 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-juiceGreen uppercase text-white">Community</h3>
        <p class="text-white text-base text-center md:text-start">JuiceBot is a fast, secure, and easy-to-use Telegram trading bot powered by the $JUICE token that lets you farm for points and earn rewards.</p>
