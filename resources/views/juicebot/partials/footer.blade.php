<footer class="flex flex-col md:flex-row items-center md:justify-between md:px-[6rem] gap-y-5 pb-3 md:pb-10">
    <div class="flex items-end md:items-center">
        ...
        <div class="hidden md:flex flex-col">
            ...
            <a target="_blank" href="/disclaimer">
                <span class="text-white hover:text-juiceGreen">Disclaimer</span>
            </a>
            <a target="_blank" href="mailto:retards@quidpixels.com">
                <span class="text-white hover:text-juiceGreen">retards@quidpixels.com</span>
            </a>
        </div>
    </div>
    <div class="flex flex-col md:items-end gap-y-5">
        ...
        <a href="" target="_blank" rel="nofollow">
            <img alt="icon" loading="lazy" width="128" height="128" decoding="async" data-nimg="1" class="w-[13vw] h-[13vw] md:w-[3vw] md:h-[3vw]" style="color:transparent" 
            src="{{asset('img/juicebot/dex.webp')}}">
        </a>
        <a href="" target="_blank" rel="nofollow">
            <img alt="icon" loading="lazy" width="128" height="128" decoding="async" data-nimg="1" class="w-[13vw] h-[13vw] md:w-[3vw] md:h-[3vw]" style="color:transparent" 
            src="{{asset('img/juicebot/gecko.png')}}">
        </a>
    </div>
        <div class="flex flex-col items-center md:hidden">
            ...
            <a href="mailto:info@juicebot.app">
