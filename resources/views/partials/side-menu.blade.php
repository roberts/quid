<div class="fixed z-50 flex flex-col pointer-events-auto top-6 right-5 js-dashboard border-2 lg:border-dark hover:border-primary">
    ...
    <div id="large_screen_menu">
        <div class="flex items-stretch justify-between text-xs font-black uppercase font-display lg:bg-dark hover:bg-primary md:text-dark lg:text-white false" id="dashboardButton">
